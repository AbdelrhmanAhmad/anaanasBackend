...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        // Use local for previews: S3 presigned URLs often fail (SignatureDoesNotMatch) with complex
        // filenames (spaces, unicode). Filament FileUpload still saves to s3 via ->disk('s3') on save.
